...
message(STATUS "_cmake_compiler_result is ${_cmake_compiler_result}")
message(STATUS "_cmake_compiler_output is ${_cmake_compiler_output}")

if (NOT _cmake_compiler_result EQUAL 0)
    message(FATAL_ERROR "Failed to fetch compiler version information with command \"${CMAKE_C_COMPILER} -v\"! Process returned with error code ${_cmake_compiler_result}. Output: ${_cmake_compiler_output}")
endif()
...
#########################################################
  ...
  if (NOT CMAKE_C_COMPILER_VERSION)
    execute_process(
      # COMMAND "Get-Command emcc"
      # COMMAND "/d/Unity_Hub/unity/2022.3.44f1c1/Editor/Data/PlaybackEngines/WebGLSupport/BuildTools/Emscripten/emscripten/emcc" -v
      # COMMAND "D:\\Unity_Hub\\unity\\2022.3.44f1c1\\Editor\\Data\\PlaybackEngines\\WebGLSupport\\BuildTools\\Emscripten\\emscripten\\emcc" -v
      COMMAND "${CMAKE_C_COMPILER}" -v
      RESULT_VARIABLE _cmake_compiler_result 
      ERROR_VARIABLE _cmake_compiler_output 
    ...
    message("_cmake_compiler_result is ${_cmake_compiler_result}")
    message("_cmake_compiler_output is ${_cmake_compiler_output}")
    if (NOT _cmake_compiler_result EQUAL 0)
